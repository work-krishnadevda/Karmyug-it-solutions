...
export default function ContactView() {
  ...
  return (
    <div className="animate-[fadeIn_0.5s_ease-out] bg-slate-50 relative overflow-hidden">
      ...
      <section className="relative py-12 select-none border-b border-slate-100 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            
            {/* Contact Card 1: Call Us */}
            <div className="relative bg-white border border-slate-200/80 p-6 sm:p-7 rounded-[28px] shadow-[0_12px_28px_rgba(15,17,26,0.03)] hover:-translate-y-1 hover:shadow-[0_18px_40px_rgba(15,17,26,0.07)] hover:border-blue-200/60 transition-all duration-300 flex flex-col justify-between items-start cursor-pointer select-none min-h-[225px] sm:min-h-[240px] group w-full">
              {/* Blue Dot Badge on top right */}
              <div className="absolute top-5 right-5 w-5 h-5 rounded-full bg-blue-50 border border-blue-100/50 flex items-center justify-center">
                <div className="w-1.5 h-1.5 rounded-full bg-[#2563EB]" />
              </div>

              {/* 3D Telephone Receiver Icon */}
              <div className="relative w-16 h-16 flex items-center justify-start mb-5 filter drop-shadow-[0_8px_14px_rgba(37,99,235,0.18)]">
            ...
            <div className="relative bg-white border border-slate-200/80 p-6 sm:p-7 rounded-[28px] shadow-[0_12px_28px_rgba(15,17,26,0.03)] hover:-translate-y-1 hover:shadow-[0_18px_40px_rgba(15,17,26,0.07)] hover:border-blue-200/60 transition-all duration-300 flex flex-col justify-between items-start cursor-pointer select-none min-h-[225px] sm:min-h-[240px] group w-full">
              ...
              <div className="flex flex-col text-left gap-1 mt-auto w-full">
                <span className="text-[14px] font-black tracking-tight text-slate-800 font-sans">Global Reach</span>
                <span className="text-[15px] sm:text-[16px] font-extrabold text-slate-800 tracking-tight font-sans mt-0.5 leading-snug">
                  India — <br />
                  Serving clients worldwide
                </span>
                <span className="text-[11px] sm:text-[11.5px] text-slate-500 font-semibold leading-normal mt-1 font-sans">We work with clients across the globe</span>
              </div>
            </div>
            ...
            <div className="relative bg-white border border-slate-200/80 p-6 sm:p-7 rounded-[28px] shadow-[0_12px_28px_rgba(15,17,26,0.03)] hover:-translate-y-1 hover:shadow-[0_18px_40px_rgba(15,17,26,0.07)] hover:border-blue-200/60 transition-all duration-300 flex flex-col justify-between items-start cursor-pointer select-none min-h-[225px] sm:min-h-[240px] group w-full">
              ...
              <div className="flex flex-col text-left gap-1 mt-auto w-full">
                <span className="text-[14px] font-black tracking-tight text-slate-800 font-sans">Working Hours</span>
                <span className="text-[15px] sm:text-[16px] font-extrabold text-slate-800 tracking-tight font-sans mt-0.5 leading-snug">
                  Mon – Sat <br />
                  10am – 7pm IST
                </span>
                <span className="text-[11px] sm:text-[11.5px] text-slate-500 font-semibold leading-normal mt-1 font-sans">We're available during business hours</span>
              </div>
            </div>
