              ...
              >
                ...
                <div className="w-full lg:w-1/2 flex items-center justify-center">
                  ...
                  >
                    ...
                    <div 
                      className="relative overflow-hidden rounded-[2rem] border border-slate-150/80 bg-white shadow-lg shadow-slate-200 project-card-3d flex"
                    >
                      ...
                      {/* PERFECT IMAGE SCALING FIX HERE */}
                      {/* fixed height ki jagah 'aspect-[16/10]' aur 'object-left-top' use kiya hai.
                          Isse text kabhi nahi katega aur image desktop screen ki tarah perfect fit aayegi. */}
                      <img
                        src={project.imageUrl}
                        alt={project.title}
                        referrerPolicy="no-referrer"
                        className="w-full aspect-[4/3] sm:aspect-video lg:aspect-[16/10] object-cover object-left-top group-hover:scale-[1.04] transition-transform duration-700"
                      />
