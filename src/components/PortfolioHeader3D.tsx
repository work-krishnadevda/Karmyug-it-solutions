...
import { Globe, Box, Users, Building2, Rocket, TrendingUp, Sparkles, Settings, ArrowUpRight, ShieldCheck, Cpu } from 'lucide-react';

export default function PortfolioHeader3D() {
  return (
    <div className="relative w-full h-[380px] sm:h-[480px] md:h-[520px] flex items-center justify-center select-none overflow-visible">
      
      {/* CSS 3D Animations & Styles */}
      ...
      <div 
        className="absolute w-[380px] h-[380px] sm:w-[480px] sm:h-[480px] bg-gradient-radial from-blue-400/25 via-indigo-500/5 to-transparent rounded-full pointer-events-none -z-10"
        style={{ animation: 'glowPulse 9s ease-in-out infinite', top: '10%' }}
      />
      <div 
        className="absolute w-[350px] h-[350px] bg-gradient-radial from-emerald-400/10 via-teal-500/0 to-transparent rounded-full pointer-events-none -z-10"
      ...
      >
        ...
        >
          ...
          {/* Primary thick glowing metallic cylinder rim */}
          <div className="absolute w-[265px] h-[265px] rounded-full bg-gradient-to-b from-[#1E293B] via-[#0F172A] to-[#020617] border-[3px] border-[#1E40AF]/60 shadow-[0_0_35px_rgba(37,99,235,0.45),inset_0_4px_20px_rgba(255,255,255,0.15)] flex items-center justify-center">
            ...
            <div className="w-[225px] h-[225px] rounded-full bg-slate-900/90 border border-sky-500/40 shadow-[0_0_20px_rgba(56,189,248,0.2)] flex items-center justify-center relative">
              ...
              {/* Concentric Circle 1 - Cyber core base */}
              <div className="w-[170px] h-[170px] rounded-full bg-gradient-to-tr from-[#1E3A8A]/90 to-sky-950/90 border border-[#06B6D4]/50 flex items-center justify-center relative">
                ...
                {/* Glowing neon cyan pulsing heart */}
                <div 
                ...
                >
                  <div className="absolute inset-1.5 rounded-full bg-cyan-400/25 blur-xs animate-pulse" />
                </div>
        ...
        {/* ====================================================
            2. sleEK VERTICAL SMARTPHONE MOCKUP (preserve-3d)
           ==================================================== */}
        <div 
        ...
        >
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-[#2E364F] via-[#101424] to-[#070A14] rounded-[34px] sm:rounded-[38px] p-2.5 sm:p-3 border-[1.5px] border-slate-700/50 shadow-[inset_0_2px_6px_rgba(255,255,255,0.45),0_18px_36px_rgba(4,7,20,0.4)] flex flex-col justify-between preserve-3d">
            ...
            <div className="relative w-full h-full bg-[#0B1226] rounded-[24px] sm:rounded-[28px] overflow-hidden flex flex-col border border-slate-900 shadow-inner">
              ...
              {/* Screen Gloss Glare Diagonal Overlay */}
              ...
              {/* ====================================================
                  HIGH-FIDELITY DASHBOARD INSIDE SCREEN
                 ==================================================== */}
              <div className="flex-1 px-2.5 pt-2 pb-3 overflow-hidden flex flex-col justify-between select-none relative z-10">
                ...
                {/* EXQUISITE NEON SPARKLINE LINE GRAPH BOX */}
                <div className="flex-1 bg-[#0F1D40]/80 rounded-xl border border-blue-400/20 p-2 flex flex-col justify-between shadow-2xs relative overflow-hidden">
                  
                  {/* Subtle Grid horizontal guides */}
                  ...
                  {/* SVG Chart precisely matching colors of screenshot */}
                  <div className="w-full h-16 sm:h-[75px] mt-1 relative z-10">
                    <svg viewBox="0 0 100 36" width="100%" height="100%" preserveAspectRatio="none">
                      ...
                      {/* Orange Line Segment (Left Half) */}
                      <path 
                        d="M0,30 L10,26 L23,28 L34,18 L48,22" 
                        fill="none" 
                        stroke="#FB923C" 
                        strokeWidth="1.8" 
                        strokeLinecap="round"
                      />
                      <path 
                        d="M0,30 L10,26 L23,28 L34,18 L48,22 L48,36 L0,36 Z" 
                        fill="url(#neonOrangeGrad)"
                      />

                      {/* Cyan Line Segment (Right Half) connected brilliantly and taking off */}
                      <path 
                        d="M48,22 Q58,16 68,14 T88,4 L100,2" 
                        fill="none" 
                        stroke="#38BDF8" 
                        strokeWidth="2.1" 
                        strokeLinecap="round"
                      />
                      <path 
                        d="M48,22 Q58,16 68,14 T88,4 L100,2 L100,36 L48,36 Z" 
                        fill="url(#neonCyanGrad)"
                      />

                      {/* Spark Glowing Peaks and connections */}
                ...
                {/* SCREEN BOTTOM SECTION - PROGRESS ORBITAL */}
        ...
        {/* Card 1: Websites 10+ (Top-Left) */}
        <div 
          className="absolute -top-12 -left-16 sm:-top-16 sm:-left-24 w-[115px] sm:w-[130px] rounded-2xl bg-gradient-to-br from-white/12 to-blue-500/5 backdrop-blur-md border border-white/45 p-3 flex flex-col justify-between items-start cursor-pointer select-none shadow-[2px_12px_28px_rgba(37,99,235,0.18),inset_0_2px_4px_rgba(255,255,255,0.4)] hover:scale-105 active:scale-95 transition-all duration-300 z-30 group anime-float-slow"
        ...
        {/* Card 2: Applications 8+ (Bottom-Left) */}
        <div 
          className="absolute bottom-8 -left-20 sm:bottom-12 sm:-left-32 w-[115px] sm:w-[130px] rounded-2xl bg-gradient-to-br from-white/12 to-indigo-500/5 backdrop-blur-md border border-white/45 p-3 flex flex-col justify-between items-start cursor-pointer select-none shadow-[2px_12px_28px_rgba(99,102,241,0.18),inset_0_2px_4px_rgba(255,255,255,0.4)] hover:scale-105 active:scale-95 transition-all duration-300 z-35 group anime-float-medium"
        ...
        {/* Card 3: Clients Served 500+ (Top-Right) */}
        <div 
          className="absolute -top-6 -right-16 sm:-top-10 sm:-right-24 w-[115px] sm:w-[130px] rounded-2xl bg-gradient-to-br from-white/12 to-sky-500/5 backdrop-blur-md border border-white/45 p-3 flex flex-col justify-between items-start cursor-pointer select-none shadow-[2px_12px_28px_rgba(14,165,233,0.18),inset_0_2px_4px_rgba(255,255,255,0.4)] hover:scale-105 active:scale-95 transition-all duration-300 z-30 group anime-float-medium animate-delay-100"
        ...
        {/* Card 4: Industries 12+ (Bottom-Right) */}
        <div 
          className="absolute bottom-16 -right-16 sm:bottom-20 sm:-right-24 w-[115px] sm:w-[130px] rounded-2xl bg-gradient-to-br from-white/12 to-teal-500/5 backdrop-blur-md border border-white/45 p-3 flex flex-col justify-between items-start cursor-pointer select-none shadow-[2px_12px_28px_rgba(20,184,166,0.18),inset_0_2px_4px_rgba(255,255,255,0.4)] hover:scale-105 active:scale-95 transition-all duration-300 z-35 group anime-float-fast"
        ...
        {/* Glossy Tilted Saturn-Like Planet with Translucent Ring (Top Right) */}
        <div 
          className="absolute -top-24 right-4 sm:-top-28 sm:right-10 w-20 h-20 pointer-events-none z-10 anime-float-slow"
          style={{ transform: 'translateZ(30px)' }}
        >
          <div className="relative w-full h-full">
            {/* Spheroid planet body with vibrant royal blue-to-purple radial shading */}
            <div className="absolute inset-2 rounded-full bg-radial from-[#93C5FD] via-[#6366F1] to-[#312E81] shadow-[inset_2px_3px_10px_rgba(255,255,255,0.4),0_8px_20px_rgba(99,102,241,0.3)]" />
            
            {/* The planet's translucent ring */}
            <div 
        ...
        {/* Glossy Ascending 3D Rocket Space Ship (Behind / Above Left side of phone) */}
        <div 
        ...
        >
          <div className="anime-rocket-shake w-full h-full flex items-center justify-center">
            <svg width="48" height="48" viewBox="0 0 56 56" fill="none">
              ...
              {/* Tiny circular portal cabin viewport */}
              <circle cx="23" cy="23" r="3.5" fill="#38BDF8" stroke="#64748B" strokeWidth="1.5" />
            </svg>
          </div>
        </div>

        {/* Small sparkling background dodecahedron shapes */}
        <div 
          className="absolute top-1/2 -left-28 w-6 h-6 rounded-md bg-gradient-to-tr from-sky-400/35 to-blue-500/20 border border-white/35 backdrop-blur-3xs anime-float-slow"
          style={{ transform: 'rotateX(30deg) rotateY(45deg) translateZ(10px)' }}
        />
        <div 
          className="absolute bottom-12 -right-28 w-5 h-5 rounded-md bg-gradient-to-tr from-purple-400/30 to-indigo-500/15 border border-white/30 backdrop-blur-3xs anime-float-medium"
