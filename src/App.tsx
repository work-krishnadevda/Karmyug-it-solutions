...
import { Sparkles, Megaphone, Target, Phone, ChevronRight, ArrowRight, Zap, TrendingUp, Activity, Shield, Users, Building2, Star, Headphones, Laptop, Clock } from 'lucide-react';

export default function App() {
  const [currentPage, setCurrentPage] = useState<'home' | 'services' | 'portfolio' | 'contact'>('home');
      ...
      {currentPage === 'home' ? (
        ...
        <div id="home" className="scroll-mt-24">
          ...
          <section className="relative pt-10 pb-12 lg:pt-20 lg:pb-16 px-6 max-w-7xl mx-auto gap-8 lg:gap-12 grid grid-cols-1 lg:grid-cols-12 items-center select-none overflow-visible font-sans">
            ...
            <div className="absolute bottom-10 right-0 w-[450px] h-[450px] bg-indigo-100/40 rounded-full blur-[130px] pointer-events-none" />
            ...
            <div className="lg:col-span-6 flex flex-col items-start text-left relative z-15 animate-[fadeIn_0.5s_ease-out]">
              ...
              <div className="mt-8.5 flex flex-col sm:flex-row items-center gap-4.5 w-full sm:w-auto">
              ...
              <div className="mt-10 flex items-center gap-4">
                ...
                <div>
                  <p className="text-[13px] font-semibold text-slate-500">
                    <span className="font-extrabold text-slate-800">250+ happy clients</span> trust our services
                  </p>
                </div>
              </div>
            ...
            <div className="lg:col-span-6 relative z-10 w-full flex justify-center items-center mt-12 lg:mt-0 px-4 select-none">
              
              {/* Radial background magical glow */}
              <div className="absolute w-[450px] h-[350px] bg-blue-200/25 rounded-full blur-[90px] -z-10" />
              ...
              <div className="relative w-full max-w-[480px] h-[330px] flex items-center justify-center [perspective:1400px]">
                ...
                >
                    ...
                    <div className="w-full h-full bg-slate-100 rounded-lg flex overflow-hidden relative">
                      ...
                      <div className="w-12 bg-slate-900 flex flex-col items-center py-2.5 gap-2.5 shrink-0 select-none border-r border-slate-950">
                        ...
                        <div className="w-5.5 h-5.5 rounded-lg bg-gradient-to-tr from-blue-500 via-indigo-500 to-pink-500 flex items-center justify-center shadow-md">
                          <span className="text-[8px] font-black text-white">KY</span>
                        </div>
                      ...
                      <div className="flex-1 p-3 flex flex-col justify-between overflow-hidden">
                        ...
                        <div className="flex items-center justify-between border-b border-slate-200/70 pb-1.5 mb-1.5">
                          <div className="flex items-center gap-1">
                            <span className="text-[10px] font-extrabold text-slate-800 font-sans tracking-tight">Dashboard</span>
                          </div>
                        ...
                        <div className="grid grid-cols-5 gap-2 flex-1 items-stretch">
                          ...
                          <div className="col-span-3 bg-white border border-slate-200/50 rounded-xl p-2 flex flex-col justify-between">
                            <span className="text-[7px] font-extrabold text-slate-400 uppercase tracking-widest block font-sans">Sales Overview</span>
                            
                            {/* Graphic wave line mockup */}
                            <div className="h-14 relative mt-1">
                              <svg className="w-full h-full" viewBox="0 0 100 40" preserveAspectRatio="none">
                                <path d="M0 35 C 15 32, 30 14, 45 28 C 65 6, 80 18, 100 2" fill="none" stroke="#2563eb" strokeWidth="2.5" strokeLinecap="round" />
                                <path d="M0 35 C 15 32, 30 14, 45 28 C 65 6, 80 18, 100 2 L 100 40 L 0 40 Z" fill="url(#dashChartGrad)" opacity="0.08" />
                                <defs>
                          ...
                          <div className="col-span-2 bg-white border border-slate-200/50 rounded-xl p-2.5 flex flex-col items-center justify-between">
                            <span className="text-[7px] font-extrabold text-slate-400 uppercase tracking-widest block text-center self-stretch font-sans">Top Channels</span>
                            
                            <div className="relative w-11 h-11 flex items-center justify-center mb-1">
                              {/* Colored concentric rings */}
                              <svg className="absolute inset-0 w-full h-full rotate-[-45deg]" viewBox="0 0 32 32">
                                <circle cx="16" cy="16" r="11" stroke="#f1f5f9" strokeWidth="3.5" fill="none" />
                                <circle cx="16" cy="16" r="11" stroke="#3b82f6" strokeWidth="3.5" strokeDasharray="69" strokeDashoffset="18" strokeLinecap="round" fill="none" />
                                <circle cx="16" cy="16" r="11" stroke="#10b981" strokeWidth="3.5" strokeDasharray="69" strokeDashoffset="44" strokeLinecap="round" fill="none" />
                                <circle cx="16" cy="16" r="11" stroke="#f59e0b" strokeWidth="3.5" strokeDasharray="69" strokeDashoffset="58" strokeLinecap="round" fill="none" />
                              </svg>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="bg-white border border-slate-200/50 rounded-xl p-2.5 mt-2 flex flex-col justify-between">
                          <span className="text-[7.5px] font-extrabold text-slate-400 uppercase tracking-widest block mb-1 font-sans">Recent Activities</span>
                          <div className="space-y-1">
                            <div className="flex items-center justify-between text-[7.5px] font-semibold text-slate-600 border-b border-slate-100 pb-0.5">
                              <span className="flex items-center gap-1.5"><span className="w-1.2 h-1.2 rounded-full bg-blue-500" /> New License Purchased</span>
                              <span className="text-slate-400 font-bold">$540 x8</span>
                            </div>
                            <div className="flex items-center justify-between text-[7.5px] font-semibold text-slate-600">
                              <span className="flex items-center gap-1.5"><span className="w-1.2 h-1.2 rounded-full bg-emerald-500 animate-pulse" /> API deployment node</span>
                              <span className="text-emerald-500 font-extrabold">Successful</span>
                            </div>
                          </div>
                        </div>
                  ...
                  <div 
                    ...
                    style={{
                      transform: 'rotateX(82deg) translateY(-8px) translateZ(-4px)',
                ...
                <div className="absolute -top-12 -right-8 z-30 bg-white/95 backdrop-blur-md border border-slate-100 p-4 rounded-[22px] shadow-[0_12px_32px_rgba(15,17,26,0.08)] flex items-center justify-between gap-5.5 w-[210px] hover:-translate-y-1 transition-transform duration-350 cursor-pointer">
                  <div>
                    <span className="text-[9.5px] text-slate-400 font-bold uppercase tracking-wider block font-mono">Total Revenue</span>
                    <h4 className="text-lg font-black text-slate-800 tracking-tight font-display mt-0.5">₹24.8M</h4>
                ...
                <div className="absolute top-[8%] -left-16 z-30 bg-white/95 backdrop-blur-md border border-slate-100 p-4 rounded-[22px] shadow-[0_12px_32px_rgba(15,17,26,0.08)] w-[180px] hover:-translate-y-1 transition-transform duration-350 cursor-pointer">
                  <span className="text-[9.5px] text-slate-400 font-bold uppercase tracking-wider block font-mono">New Customers</span>
                  <div className="flex items-center justify-between mt-0.5">
                    <h4 className="text-lg font-black text-slate-800 tracking-tight font-display">2,356</h4>
                  ...
                  <div className="w-full h-7 mt-2.5">
                    <svg className="w-full h-full" viewBox="0 0 100 30" preserveAspectRatio="none">
                      <path d="M0 25 Q 25 5, 50 20 T 100 5" fill="none" stroke="#10b981" strokeWidth="2" strokeLinecap="round" />
                      <path d="M0 25 Q 25 5, 50 20 T 100 5 L 100 30 L 0 30 Z" fill="url(#greenSparkGrad)" opacity="0.1" />
                      <defs>
                ...
                <div className="absolute top-[38%] -right-12 z-30 bg-white/95 backdrop-blur-md border border-slate-100 p-4 rounded-[22px] shadow-[0_12px_32px_rgba(15,17,26,0.08)] w-[135px] text-center hover:-translate-y-1 transition-transform duration-350 cursor-pointer">
                  <span className="text-[9.5px] text-slate-400 font-bold uppercase tracking-wider block mb-2 font-mono">Project Progress</span>
                  
                  <div className="relative w-16 h-16 mx-auto flex items-center justify-center">
                    {/* Circular dial gauge representation */}
                    <svg className="absolute inset-0 w-full h-full rotate-[-90deg]">
                      <circle cx="32" cy="32" r="26" stroke="#f1f5f9" strokeWidth="5.5" fill="none" />
                      <circle cx="32" cy="32" r="26" stroke="url(#circularProgressGrad)" strokeWidth="5.5" strokeDasharray="163" strokeDashoffset="36" strokeLinecap="round" fill="none" />
                      <defs>
                        <linearGradient id="circularProgressGrad" x1="0%" y1="0%" x2="100%" y2="100%">
                    ...
                    <div className="z-10 text-center">
                      <span className="block text-sm font-black text-slate-800 leading-none">78%</span>
                      <span className="text-[8px] font-bold text-emerald-500 mt-0.5 block">On Track</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="absolute bottom-[2%] -left-12 z-40 bg-white/95 border border-slate-200/60 p-4 rounded-[22px] shadow-[0_15px_35px_rgba(15,17,26,0.09)] w-[165px] hover:-translate-y-1 transition-transform duration-350 cursor-pointer">
                  <span className="text-[9.5px] text-slate-400 font-bold uppercase tracking-widest block font-mono">AI Automation</span>
                  <h4 className="text-xl font-black text-slate-800 tracking-tight font-display mt-0.5">300+</h4>
                  <p className="text-[10px] font-bold text-slate-500 leading-none mt-1">Hours Saved</p>
                </div>
                ...
                <div className="absolute left-[-6.5rem] top-[40%] z-20 pointer-events-none opacity-90 animate-[bounce_4.5s_infinite_ease-in-out]">
                  <svg width="70" height="75" viewBox="0 0 100 105" fill="none">
                    <path d="M50 5 L90 20 V55 C90 77 73 95 50 101 C27 95 10 77 10 55 V20 L50 5 Z" fill="url(#shieldGlassFill)" stroke="url(#shieldGlassStroke)" strokeWidth="2" />
                    <circle cx="50" cy="50" r="14" fill="#60a5fa" opacity="0.3" />
                    <circle cx="50" cy="50" r="8" fill="#3b82f6" />
                    <defs>
                      <linearGradient id="shieldGlassFill" x1="0%" y1="0%" x2="100%" y2="100%">
                        <stop offset="0%" stopColor="#93c5fd" stopOpacity="0.3" />
                        <stop offset="100%" stopColor="#3b82f6" stopOpacity="0.6" />
                      </linearGradient>
                      <linearGradient id="shieldGlassStroke" x1="0%" y1="0%" x2="100%" y2="100%">
                ...
                <div className="absolute -top-16 left-[22%] opacity-60 pointer-events-none animate-[spin_25s_linear_infinite] -z-10">
                  <svg width="60" height="60" viewBox="0 0 100 100" fill="none">
                    <circle cx="50" cy="50" r="32" stroke="url(#torusCoreGrad)" strokeWidth="12" />
                    <defs>
                      <linearGradient id="torusCoreGrad" x1="0%" y1="0%" x2="100%" y2="100%">
                ...
                <div className="absolute right-[-4rem] top-[-3.5rem] opacity-75 pointer-events-none animate-[spin_40s_linear_infinite] -z-10">
                  <svg width="45" height="45" viewBox="0 0 60 60" fill="none" className="rotate-[20deg]">
                    <path d="M30 5 L55 18 V42 L30 55 L5 42 V18 L30 5 Z" fill="url(#glossBlockGrad)" stroke="white" strokeWidth="0.5" />
                    <defs>
                      <linearGradient id="glossBlockGrad" x1="0%" y1="0%" x2="100%" y2="100%">
                ...
                <div className="absolute left-[8%] bottom-[-5.5rem] opacity-70 pointer-events-none animate-[spin_35s_linear_infinite] -z-10">
                  <svg width="50" height="50" viewBox="0 0 60 60" fill="none" className="rotate-[-32deg]">
                    <path d="M30 5 L55 18 V42 L30 55 L5 42 V18 L30 5 Z" fill="url(#glossBlockGrad2)" stroke="white" strokeWidth="0.5" />
                    <defs>
                      <linearGradient id="glossBlockGrad2" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <section className="relative pb-16 pt-6 select-none z-20">
            <div className="max-w-7xl mx-auto px-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                {/* Stats Card 1 */}
                <div className="bg-white/75 backdrop-blur-md border border-slate-200/50 p-6.5 rounded-[26px] shadow-[0_8px_30px_rgba(241,245,249,0.5)] hover:-translate-y-1 hover:shadow-lg hover:border-blue-200/60 transition-all duration-300 flex items-center gap-4.5 cursor-pointer">
                  <div className="w-13 h-13 rounded-2xl bg-blue-50/80 flex items-center justify-center text-blue-600 shrink-0 shadow-inner">
                    <Users className="w-6.5 h-6.5 text-blue-500" />
                  </div>
                  <div>
                    <h4 className="text-2xl sm:text-3xl font-black font-display tracking-tight text-slate-900 leading-none">250+</h4>
                    <p className="text-[12px] font-extrabold text-[#64748B] uppercase tracking-wider mt-1.5 font-mono">Clients Served</p>
                  </div>
                </div>

                {/* Stats Card 2 */}
                <div className="bg-white/75 backdrop-blur-md border border-slate-200/50 p-6.5 rounded-[26px] shadow-[0_8px_30px_rgba(241,245,249,0.5)] hover:-translate-y-1 hover:shadow-lg hover:border-emerald-200/60 transition-all duration-300 flex items-center gap-4.5 cursor-pointer">
                  <div className="w-13 h-13 rounded-2xl bg-emerald-50/80 flex items-center justify-center text-emerald-600 shrink-0 shadow-inner">
                    <Building2 className="w-6.5 h-6.5 text-emerald-500" />
                  </div>
                  <div>
                    <h4 className="text-2xl sm:text-3xl font-black font-display tracking-tight text-slate-900 leading-none">15+</h4>
                    <p className="text-[12px] font-extrabold text-[#64748B] uppercase tracking-wider mt-1.5 font-mono">Industries Covered</p>
                  </div>
                </div>

                {/* Stats Card 3 */}
                <div className="bg-white/75 backdrop-blur-md border border-slate-200/50 p-6.5 rounded-[26px] shadow-[0_8px_30px_rgba(241,245,249,0.5)] hover:-translate-y-1 hover:shadow-lg hover:border-amber-200/60 transition-all duration-300 flex items-center gap-4.5 cursor-pointer">
                  <div className="w-13 h-13 rounded-2xl bg-amber-50/80 flex items-center justify-center text-amber-500 shrink-0 shadow-inner">
                    <Star className="w-6.5 h-6.5 text-amber-500 fill-amber-400" />
                  </div>
                  <div>
                    <h4 className="text-2xl sm:text-3xl font-black font-display tracking-tight text-slate-900 leading-none">98%</h4>
                    <p className="text-[12px] font-extrabold text-[#64748B] uppercase tracking-wider mt-1.5 font-mono">Client Satisfaction</p>
                  </div>
                </div>

                {/* Stats Card 4 */}
                <div className="bg-white/75 backdrop-blur-md border border-slate-200/50 p-6.5 rounded-[26px] shadow-[0_8px_30px_rgba(241,245,249,0.5)] hover:-translate-y-1 hover:shadow-lg hover:border-rose-200/60 transition-all duration-300 flex items-center gap-4.5 cursor-pointer">
                  <div className="w-13 h-13 rounded-2xl bg-rose-50/80 flex items-center justify-center text-rose-500 shrink-0 shadow-inner">
                    <Headphones className="w-6.5 h-6.5 text-rose-500" />
                  </div>
                  <div>
                    <h4 className="text-2xl sm:text-3xl font-black font-display tracking-tight text-slate-900 leading-none">24/7</h4>
                    <p className="text-[12px] font-extrabold text-[#64748B] uppercase tracking-wider mt-1.5 font-mono">Support Available</p>
                  </div>
                </div>
          ...
          <section className="py-24 bg-[#FAFBFD] w-full text-center relative overflow-hidden select-none border-t border-slate-200/80">
            ...
            <div className="max-w-6xl mx-auto px-6 relative z-10">
              ...
              <p className="text-sm sm:text-base md:text-[17px] text-slate-500 max-w-4xl mx-auto leading-relaxed mb-10 font-semibold font-sans">
                Let's discuss your project — whether it's a new website, mobile app, or full digital transformation. Free consultation, no obligation.
              </p>
